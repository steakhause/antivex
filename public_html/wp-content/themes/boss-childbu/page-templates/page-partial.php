<?php
/**
 * Template Name: Partial Page Template
 *
				  ...
				  <div class="entry-content">
					  <?php while ( have_posts() ) : the_post(); ?>
							<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
								<header class="entry-header <?php if(is_search()){ echo 'page-header'; }?> partial-header" >
									<!-- <h1 class="entry-title <?php if(is_search()){ echo 'main-title'; }?>"><?php the_title(); ?></h1> -->
									<img src="https://learn.cleverinvestor.com/wp-content/themes/boss-child/images/partials-bg.jpg" alt="banner_img"/>
								</header>
							<div class="entry-content">
								<?php the_content(); ?>
