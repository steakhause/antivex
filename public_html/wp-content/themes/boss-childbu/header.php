...
if($_SERVER['HTTP_REFERER'] == site_url('/') && is_page(1028)){
	if(!isset($_COOKIE["login_tracked_for_is"])) {
		do_action('set_login_count_in_is');
		setcookie("login_tracked_for_is", true, time() + (900), "/");
	}
}
...
<html <?php language_attributes(); ?>>
	...
	<head>
		...
		<?php wp_head(); ?>
		<?php if(memb_hasAnyTags('14214')) { ?>
			<style type="text/css">
			.role-subscriber .notificationhide {
